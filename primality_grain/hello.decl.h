...
class CkIndex_Main:public CkIndex_Chare{
  public:
    ...
    /* DECLS: void recv(long n, int ind, int num, int res);
     */
    // Entry point registration at startup
    
    static int reg_recv_marshall3();
    // Entry point index lookup
    
    inline static int idx_recv_marshall3() {
      static int epidx = reg_recv_marshall3();
      return epidx;
    }

    
    inline static int idx_recv(void (Main::*)(long n, int ind, int num, int res) ) {
      return idx_recv_marshall3();
    }


    
    static int recv(long n, int ind, int num, int res) { return idx_recv_marshall3(); }
    
    static void _call_recv_marshall3(void* impl_msg, void* impl_obj);
    
    static void _call_sdag_recv_marshall3(void* impl_msg, void* impl_obj);
    
    static int _callmarshall_recv_marshall3(char* impl_buf, void* impl_obj_void);
    
    static void _marshallmessagepup_recv_marshall3(PUP::er &p,void *msg);
};
/* --------------- element proxy ------------------ */
 ...
 */
    ...
    void recv(long n, int ind, int num, int res, const CkEntryOptions *impl_e_opts=NULL);
...
class CkIndex_Hello:public CkIndex_ArrayElement{
  public:
    ...
    /* DECLS: void ComputePrimeArray(const long *n, int inputSize);
     */
    // Entry point registration at startup
    
    static int reg_ComputePrimeArray_marshall2();
    // Entry point index lookup
    
    inline static int idx_ComputePrimeArray_marshall2() {
      static int epidx = reg_ComputePrimeArray_marshall2();
      return epidx;
    }

    
    inline static int idx_ComputePrimeArray(void (Hello::*)(const long *n, int inputSize) ) {
      return idx_ComputePrimeArray_marshall2();
    }


    
    static int ComputePrimeArray(const long *n, int inputSize) { return idx_ComputePrimeArray_marshall2(); }
    
    static void _call_ComputePrimeArray_marshall2(void* impl_msg, void* impl_obj);
    
    static void _call_sdag_ComputePrimeArray_marshall2(void* impl_msg, void* impl_obj);
    
    static int _callmarshall_ComputePrimeArray_marshall2(char* impl_buf, void* impl_obj_void);
    
    static void _marshallmessagepup_ComputePrimeArray_marshall2(PUP::er &p,void *msg);
 ...
 */
    ...
    void ComputePrimeArray(const long *n, int inputSize, const CkEntryOptions *impl_e_opts=NULL) ;
...
class Closure_Hello {
  public:
    ...
    struct ComputePrimeArray_2_closure;
