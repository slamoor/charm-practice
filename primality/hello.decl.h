...
class CkIndex_Main:public CkIndex_Chare{
  public:
    ...
    /* DECLS: void recv(long long n, int ind, int res);
     */
    // Entry point registration at startup
    ...
    inline static int idx_recv(void (Main::*)(long long n, int ind, int res) ) {
      return idx_recv_marshall3();
    }


    
    static int recv(long long n, int ind, int res) { return idx_recv_marshall3(); }
 ...
 */
    ...
    void recv(long long n, int ind, int res, const CkEntryOptions *impl_e_opts=NULL);
...
class CkIndex_Hello:public CkIndex_ArrayElement{
  public:
    ...
    inline static int idx_SayHi(void (Hello::*)(long long n) ) {
      return idx_SayHi_marshall2();
    }


    
    static int SayHi(long long n) { return idx_SayHi_marshall2(); }
 ...
 */
    ...
    void SayHi(long long n, const CkEntryOptions *impl_e_opts=NULL) ;
